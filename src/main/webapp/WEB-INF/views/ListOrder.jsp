...
<link rel="stylesheet" href="/TechWorldAdmin/URLToReachResourcesFolder/css/ListOrder.css">
                ...
                <table id="customers">
					...
					<c:forEach var = "order" items = "${listOrder}">
						<tr>
	                      ...
	                      <td>
	                      	<c:if test="${order.orderStatusEntity.idStatus == 1}">
	                      		<p class="status new">${order.orderStatusEntity.nameStatus}</p>
	                      	</c:if>
	                      	<c:if test="${order.orderStatusEntity.idStatus == 2}">
	                      		<p class="status packing">${order.orderStatusEntity.nameStatus}</p>
	                      	</c:if>
	                      	<c:if test="${order.orderStatusEntity.idStatus == 3}">
	                      		<p class="status delivered">${order.orderStatusEntity.nameStatus}</p>
	                      	</c:if>
	                      	<c:if test="${order.orderStatusEntity.idStatus == 4}">
	                      		<p class="status success">${order.orderStatusEntity.nameStatus}</p>
	                      	</c:if>
	                      </td>
