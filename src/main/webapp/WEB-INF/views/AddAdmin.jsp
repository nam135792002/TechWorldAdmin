...
<body>
                      ...
                      <form action="add_admin/save_add" method="post" onsubmit="return validateForm();">
                        ...
                        <div class="user-details">
                          <div class="input-box">
                            ...
                            <input type="text" placeholder="Enter your name" id="fullName" name="nameAdmin" value="${admin.nameAdmin}">
                            <div class="error-message"></div>
                          </div>
                          <div class="input-box">
                            <span class="details">Username</span>
                            <input type="text" placeholder="Enter your username" id="userName" name="username" value="${admin.username}">
                            <div class="error-message"></div>
                          </div>
                          <div class="input-box">
                            <span class="details">Email</span>
                            <input type="email" placeholder="Enter your email" id="email" name="email" value="${admin.email}">
                            <div class="error-message"></div>
                          </div>
                          <div class="input-box">
                            <span class="details">Phone Number</span>
                            <input type="text" placeholder="Enter your number" id="phoneNumber" name="phoneNumber" value="${admin.phoneNumber}">
                            <div class="error-message"></div>
                          </div>
                          <div class="input-box">
	...
	<script type="text/javascript">
		...
		if (status === "duplicateUsername") {
			swal("Sorry", "Duplicate username!", "error");
		}
	</script>
</body>
</html>